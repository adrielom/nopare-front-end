	...
	return (
		<div className='testes-section'>
			...
			<div className='testes-wrapper'>
				...
				<p>
					A No Pare submeteu suas cintas protetivas aos mais rigorosos testes de
					resistência, com disparos de alguns dos mais efetivos e potentes
					calibres de armas de fogo, seguidos de pilotagem em condição de fuga.
					Confira os resultados nos vídeos.
				</p>
				<div className='video-container article-video-container'>
					<iframe
						className='video-responsive-iframe'
						width='560'
						height='315'
